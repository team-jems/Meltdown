...
Game2.prototype = {
  ...
  create: function(){
    ...
    // ROTATOR
    this.rotator = this.roomObjs.create(this.game.world.width - 150, 10, 'arrow');
    ...
    this.Panel.init(this.game, this.game.state.states['Main'].puzzles[1]);
